...
pub mod hello_world {
  ...
  pub mod _private {
    pub const TYPE_ID: u64 = 0xec56_a2c6_0018_9a37;
  }
  ...
  pub mod hello_request {
    ...
    mod _private {
      pub static ENCODED_NODE: [::capnp::Word; 36] = [
        ...
        ::capnp::word(229, 243, 26, 167, 206, 159, 234, 250),
        ::capnp::word(29, 0, 0, 0, 1, 0, 0, 0),
        ::capnp::word(55, 154, 24, 0, 198, 162, 86, 236),
        ::capnp::word(1, 0, 7, 0, 0, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(49, 0, 0, 0, 99, 0, 0, 0),
        ...
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(104, 101, 108, 108, 111, 95, 119, 111),
        ::capnp::word(114, 108, 100, 46, 99, 97, 112, 110),
        ::capnp::word(112, 58, 72, 101, 108, 108, 111, 87),
        ::capnp::word(111, 114, 108, 100, 46, 72, 101, 108),
      ...
      pub const TYPE_ID: u64 = 0xfaea_9fce_a71a_f3e5;
    }
  }
  ...
  pub mod hello_reply {
    ...
    mod _private {
      pub static ENCODED_NODE: [::capnp::Word; 35] = [
        ::capnp::word(0, 0, 0, 0, 6, 0, 6, 0),
        ::capnp::word(235, 197, 224, 207, 5, 80, 50, 142),
        ::capnp::word(29, 0, 0, 0, 1, 0, 0, 0),
        ::capnp::word(55, 154, 24, 0, 198, 162, 86, 236),
        ::capnp::word(1, 0, 7, 0, 0, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(105, 0, 0, 0, 156, 0, 0, 0),
      ...
      pub static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
      pub static MEMBERS_BY_NAME : &[u16] = &[0];
      pub const TYPE_ID: u64 = 0x8e32_5005_cfe0_c5eb;
    }
  }
  ...
  pub mod say_hello_params {
    ...
    mod _private {
      pub static ENCODED_NODE: [::capnp::Word; 35] = [
        ::capnp::word(0, 0, 0, 0, 6, 0, 6, 0),
        ::capnp::word(216, 135, 119, 156, 226, 65, 142, 162),
        ::capnp::word(29, 0, 0, 0, 1, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(1, 0, 7, 0, 0, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ...
        ::capnp::word(114, 108, 100, 46, 99, 97, 112, 110),
        ::capnp::word(112, 58, 72, 101, 108, 108, 111, 87),
        ::capnp::word(111, 114, 108, 100, 46, 115, 97, 121),
        ::capnp::word(72, 101, 108, 108, 111, 36, 80, 97),
      ...
      pub static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
      pub static MEMBERS_BY_NAME : &[u16] = &[0];
      pub const TYPE_ID: u64 = 0xa28e_41e2_9c77_87d8;
    }
  }
  ...
  pub mod say_hello_results {
    ...
    mod _private {
      pub static ENCODED_NODE: [::capnp::Word; 35] = [
        ::capnp::word(0, 0, 0, 0, 6, 0, 6, 0),
        ::capnp::word(151, 204, 160, 148, 99, 183, 173, 144),
        ::capnp::word(29, 0, 0, 0, 1, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(1, 0, 7, 0, 0, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ...
        ::capnp::word(112, 58, 72, 101, 108, 108, 111, 87),
        ::capnp::word(111, 114, 108, 100, 46, 115, 97, 121),
        ::capnp::word(72, 101, 108, 108, 111, 36, 82, 101),
      ...
      pub static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
      pub static MEMBERS_BY_NAME : &[u16] = &[0];
      pub const TYPE_ID: u64 = 0x90ad_b763_94a0_cc97;
    }
  }
}
